			...
			<div class="sidebar-content">
				...
				<div class="card card-sidebar-mobile">
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<!-- Tables -->
						<li class="nav-item-header"><div class="text-uppercase font-size-xs line-height-xs">Capital Humano</div> <i class="icon-menu" title="Tables"></i></li><!--
						<li class="nav-item nav-item-submenu">
						...
						<li class="nav-item nav-item-submenu">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Data tables">
								...
								<li class="nav-item"><a href="form_input_groups.html" class="nav-link">Editar</a></li>
						...
						<li class="nav-item nav-item-submenu">
							<a href="#" class="nav-link"><i class="icon-alignment-unalign"></i> <span>Departamentos</span></a>
							<ul class="nav nav-group-sub" data-submenu-title="Data tables extensions">
								<li class="nav-item"><a href="form_inputs.html" class="nav-link">Agregar</a></li>
								<li class="nav-item"><a href="formulario_editar.html" class="nav-link">Editar</a></li>
								<li class="nav-item"><a href="datatable_extension_fixed_columns.html" class="nav-link">Listar</a></li>
								<li class="nav-item"><a href="datatable_extension_fixed_header.html" class="nav-link">Eliminar</a></li><!--
						...
						<li class="nav-item nav-item-submenu">
							<a href="#" class="nav-link"><i class="icon-file-spreadsheet"></i> <span>Empresas</span></a>
							<ul class="nav nav-group-sub" data-submenu-title="Handsontable">
								<li class="nav-item"><a href="handsontable_basic.html" class="nav-link">Agregar</a></li>
								<li class="nav-item"><a href="handsontable_advanced.html" class="nav-link">Editar</a></li>
								<li class="nav-item"><a href="handsontable_cols.html" class="nav-link">Listar</a></li>
								<li class="nav-item"><a href="handsontable_cells.html" class="nav-link">Eliminar</a></li>
						...
						<li class="nav-item nav-item-submenu">
							<a href="#" class="nav-link"><i class="icon-versions"></i> <span>Vacaciones</span></a>
							<ul class="nav nav-group-sub" data-submenu-title="Responsive tables">
								<li class="nav-item"><a href="table_responsive.html" class="nav-link">Agregar</a></li>
								<li class="nav-item"><a href="datatable_responsive.html" class="nav-link">Editar</a></li>
								<li class="nav-item"><a href="handsontable_types.html" class="nav-link">Listar</a></li>
								<li class="nav-item"><a href="handsontable_custom_checks.html" class="nav-link">Eliminar</a></li><!--
								<li class="nav-item"><a href="handsontable_ac_password.html" class="nav-link">Autocomplete &amp; password</a></li>
								<li class="nav-item"><a href="handsontable_search.html" class="nav-link">Search</a></li>
								<li class="nav-item"><a href="handsontable_context.html" class="nav-link">Context menu</a></li>-->
							</ul>
